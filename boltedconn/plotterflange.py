...
def l_flange_plotter(
    ...
    ys_to_hole = [-flange_thickness, 0, 0]
    ...
    ys_outer = [-flange_thickness, -flange_thickness, 0, 0, -flange_thickness]
    ...
    fig.add_trace(go.Scatter(x=[-b_star, -b_star], y=[flange_thickness / 3, -flange_thickness * 4/3],
            mode="lines", line=dict(color="black", width=2, dash="dot"), showlegend=False))

    ## annotations
    fig = flange_t_annotation(fig, flange_length, flange_thickness)
    fig = b_star_annotation(fig, flange_thickness, b_star)
    fig = flange_height_annotation(fig, total_height)
    fig = flange_length_annotation(fig, total_height, flange_length)
    fig = hole_diameter_annotation(fig, b_star, flange_thickness, hole_diameter)
    ...
    fig.update_layout(
        ...
        yaxis=dict(range=[-total_height * 1.2, flange_thickness * 0.5], title='Y (mm)'),
        showlegend=False)
